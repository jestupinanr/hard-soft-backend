...
exports.ResourceTypeController = void 0;
const common_1 = require("@nestjs/common");
const jwt_auth_guard_1 = require("../../auth/jwt-auth.guard");
const resource_brand_1 = require("../dtos/resource-brand");
const types_service_1 = require("../services/types.service");
let ResourceTypeController = class ResourceTypeController {
    constructor(resourceTypesService) {
