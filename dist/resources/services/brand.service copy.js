...
let HardwareBrandService = class HardwareBrandService {
    constructor(resourceBrandRepository) {
        this.resourceBrandRepository = resourceBrandRepository;
    }
    findAll(query) {
        const { resource } = query;
        return this.resourceBrandRepository.find({
            where: Object.assign({}, (resource) && {
                resource
            })
        });
    }
...
//# sourceMappingURL=brand.service%20copy.js.map